...
class NewVisitorTest(unittest.TestCase):
    ...
    def test_can_start_a_list_and_retrive_it_later(self):
        ...
        #She is invited to enter a to-do imtem straight away
        ...
        inputbox = se;f.browser.find_element_by_id('id_new_item')
        ...
        self.assertIn('1: Buy peacick feathers', [row.text for row in rows])
        self.assertIn(
            '2 Use peacock feathers to make a fly',
            [row.text for row in rows]
        )

        #Edith wonders wheater the site will remember ger list. Then she sees that the site has generated a unique URL for her --
        #there is some explanatory text to that effect.
        self.fail('Finish the test!')

#She visits that URL - her to-do list is still thereself.
